    ...
    <div className="flex-1 overflow-y-auto bg-[#f5f5f7] dark:bg-[#191919]">
      <div className="max-w-3xl mx-auto px-8 py-12">
        ...
        <div className="flex flex-col items-center justify-center py-24 gap-4">
          <div className="w-20 h-20 rounded-[22px] bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center text-4xl shadow-lg">
            📒
          </div>
          <p className="text-lg font-semibold text-[#37352f] dark:text-[#e6e6e4]">수입/지출 장부</p>
